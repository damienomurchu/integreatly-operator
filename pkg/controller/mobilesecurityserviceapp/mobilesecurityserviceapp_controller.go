...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MobileSecurityServiceApp
...
// blank assignment to verify that ReconcileMobileSecurityServiceApp implements reconcile.Reconciler
...
func (r *ReconcileMobileSecurityServiceApp) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set MobileSecurityServiceApp instance as the owner and controller
...
func newPodForCR(cr *mobilesecurityservicev1alpha1.MobileSecurityServiceApp) *corev1.Pod {
