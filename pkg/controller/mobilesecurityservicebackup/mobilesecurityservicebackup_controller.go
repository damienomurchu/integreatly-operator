...
import (
	...
	mobilesecurityservicev1alpha1 "github.com/integr8ly/integreatly-operator/pkg/apis/mobilesecurityservice/v1alpha1"
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileMobileSecurityServiceBackup{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MobileSecurityServiceBackup
...
func (r *ReconcileMobileSecurityServiceBackup) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the MobileSecurityServiceBackup instance
	...
	// Set MobileSecurityServiceBackup instance as the owner and controller
...
func newPodForCR(cr *mobilesecurityservicev1alpha1.MobileSecurityServiceBackup) *corev1.Pod {
