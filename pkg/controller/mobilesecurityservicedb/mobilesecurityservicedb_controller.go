...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MobileSecurityServiceDB
...
// blank assignment to verify that ReconcileMobileSecurityServiceDB implements reconcile.Reconciler
...
func (r *ReconcileMobileSecurityServiceDB) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling MobileSecurityServiceDB")
...
func newPodForCR(cr *mobilesecurityservicev1alpha1.MobileSecurityServiceDB) *corev1.Pod {
